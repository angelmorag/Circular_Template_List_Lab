...
// === 6. Main Program Loop ===
int main() {
	LinkedList<Song*> myPlaylist; // Using Media* for polymorphism
    int choice = 0;
    ...
    do {
        ...
        std::cout << "5. Play Next Media Item" << std::endl;
    ...
    // Destructor of LinkedList<Song*> automatically cleans up all media.
    return 0;
}
